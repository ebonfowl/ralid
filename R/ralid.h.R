...
ralidOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    ...
    public = list(
        initialize = function(
            ...
            private$..nBoot <- jmvcore::OptionInteger$new(
                ...
                min=100,
                max=10000)
            private$..includeClinLimits <- jmvcore::OptionBool$new(
                "includeClinLimits",
                includeClinLimits,
                default=FALSE)
            ...
            private$..showBA <- jmvcore::OptionBool$new(
                ...
                showBA,
                default=TRUE)
            private$..baTrend <- jmvcore::OptionBool$new(
                "baTrend",
                baTrend,
                default=FALSE)
            private$..baTrendMethod <- jmvcore::OptionList$new(
                "baTrendMethod",
                baTrendMethod,
                options=list(
                    "lm",
            ...
            self$.addOption(private$..includeClinLimits)
            self$.addOption(private$..clinicalLower)
            self$.addOption(private$..clinicalUpper)
            self$.addOption(private$..showBA)
            self$.addOption(private$..baTrend)
            self$.addOption(private$..baTrendMethod)
    ...
    active = list(
        ...
        includeClinLimits = function() private$..includeClinLimits$value,
        ...
        baTrend = function() private$..baTrend$value,
        baTrendMethod = function() private$..baTrendMethod$value,
